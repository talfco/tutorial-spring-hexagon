...
public class Header extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static clb.infra.Header.Builder newBuilder() {
    return new clb.infra.Header.Builder();
  }
   ...
   * @return A new Header RecordBuilder
   */
  public static clb.infra.Header.Builder newBuilder(clb.infra.Header.Builder other) {
    return new clb.infra.Header.Builder(other);
  }
   ...
   * @return A new Header RecordBuilder
   */
  public static clb.infra.Header.Builder newBuilder(clb.infra.Header other) {
    return new clb.infra.Header.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Header>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(clb.infra.Header.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(clb.infra.Header other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.avroFingerprint)) {
        this.avroFingerprint = data().deepCopy(fields()[0].schema(), other.avroFingerprint);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.infra.Header.Builder setAvroFingerprint(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.infra.Header.Builder clearAvroFingerprint() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.infra.Header.Builder setLastUpdateLoginId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.infra.Header.Builder clearLastUpdateLoginId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.infra.Header.Builder setLastUpdateTimestamp(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.infra.Header.Builder clearLastUpdateTimestamp() {
