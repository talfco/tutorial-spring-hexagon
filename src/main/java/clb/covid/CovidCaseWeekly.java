...
public class CovidCaseWeekly extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static CovidCaseWeekly fromByteBuffer(
   ...
   private clb.infra.Header header;
   ...
   */
  public CovidCaseWeekly(clb.infra.Header header, java.lang.Integer reportingWeek, java.lang.Integer reportingYear, java.lang.String countriesAndTerritories, java.lang.String countryCode, java.lang.String continent, java.lang.String indicator, java.lang.Long weeklyCount, java.lang.Long cumulativeCount, java.lang.String source, java.lang.Long population2019, java.lang.Float cumNum14daysPer1000) {
    this.header = header;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: header = (clb.infra.Header)value$; break;
   ...
   */
  public clb.infra.Header getHeader() {
    return header;
  }
   ...
   */
  public static clb.covid.CovidCaseWeekly.Builder newBuilder() {
    return new clb.covid.CovidCaseWeekly.Builder();
  }
   ...
   * @return A new CovidCaseWeekly RecordBuilder
   */
  public static clb.covid.CovidCaseWeekly.Builder newBuilder(clb.covid.CovidCaseWeekly.Builder other) {
    return new clb.covid.CovidCaseWeekly.Builder(other);
  }
   ...
   * @return A new CovidCaseWeekly RecordBuilder
   */
  public static clb.covid.CovidCaseWeekly.Builder newBuilder(clb.covid.CovidCaseWeekly other) {
    return new clb.covid.CovidCaseWeekly.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CovidCaseWeekly>
    ...
    private clb.infra.Header header;
    private clb.infra.Header.Builder headerBuilder;
    private int reportingWeek;
    private int reportingYear;
    private java.lang.String countriesAndTerritories;
    private java.lang.String countryCode;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(clb.covid.CovidCaseWeekly.Builder other) {
      super(other);
      ...
      if (other.hasHeaderBuilder()) {
        this.headerBuilder = clb.infra.Header.newBuilder(other.getHeaderBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(clb.covid.CovidCaseWeekly other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.header)) {
        this.header = data().deepCopy(fields()[0].schema(), other.header);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setHeader(clb.infra.Header value) {
     ...
     * @return This builder.
     */
    public clb.infra.Header.Builder getHeaderBuilder() {
      if (headerBuilder == null) {
        if (hasHeader()) {
          setHeaderBuilder(clb.infra.Header.newBuilder(header));
        } else {
          setHeaderBuilder(clb.infra.Header.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public clb.covid.CovidCaseWeekly.Builder setHeaderBuilder(clb.infra.Header.Builder value) {
      clearHeader();
      headerBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearHeader() {
      header = null;
      headerBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setReportingWeek(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearReportingWeek() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setReportingYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearReportingYear() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setCountriesAndTerritories(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearCountriesAndTerritories() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setCountryCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearCountryCode() {
      countryCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setContinent(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearContinent() {
      continent = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setIndicator(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearIndicator() {
      indicator = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setWeeklyCount(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearWeeklyCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setCumulativeCount(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearCumulativeCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setSource(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearSource() {
      source = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setPopulation2019(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearPopulation2019() {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder setCumNum14daysPer1000(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public clb.covid.CovidCaseWeekly.Builder clearCumNum14daysPer1000() {
    ...
    public CovidCaseWeekly build() {
      try {
        ...
        if (headerBuilder != null) {
          ...
          record.header = fieldSetFlags()[0] ? this.header : (clb.infra.Header) defaultValue(fields()[0]);
        }
