...
public class Header extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3104580737472183015L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Header\",\"namespace\":\"net.cloudburo.hexagon.demo.domain.covid\",\"doc\":\"The header record stores important (meta-) information about the record, certain fields are optional in case an initial creation is done\",\"fields\":[{\"name\":\"avroFingerprint\",\"type\":\"long\",\"doc\":\"The fingerprint of the schema used by record producer, http://avro.apache.org/docs/1.8.2/spec.html#schema_fingerprints.\"},{\"name\":\"lastUpdateLoginId\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"doc\":\"Login id  who produced the record\",\"default\":null},{\"name\":\"lastUpdateTimestamp\",\"type\":[\"null\",\"long\"],\"doc\":\"The Update timestamp when the record was persisted. Null for the update of a record, will be newly calculated by persistency adpapter\",\"default\":null,\"logical-type\":\"time-micros\"}]}");
  ...
  /** The fingerprint of the schema used by record producer, http://avro.apache.org/docs/1.8.2/spec.html#schema_fingerprints. */
   private long avroFingerprint;
  /** Login id  who produced the record */
   private java.lang.String lastUpdateLoginId;
  /** The Update timestamp when the record was persisted. Null for the update of a record, will be newly calculated by persistency adpapter */
   ...
   * @param avroFingerprint The fingerprint of the schema used by record producer, http://avro.apache.org/docs/1.8.2/spec.html#schema_fingerprints.
   * @param lastUpdateLoginId Login id  who produced the record
   * @param lastUpdateTimestamp The Update timestamp when the record was persisted. Null for the update of a record, will be newly calculated by persistency adpapter
   */
   ...
   * @return The fingerprint of the schema used by record producer, http://avro.apache.org/docs/1.8.2/spec.html#schema_fingerprints.
   */
   ...
   * @return Login id  who produced the record
   */
   ...
   * @return The Update timestamp when the record was persisted. Null for the update of a record, will be newly calculated by persistency adpapter
   */
   ...
   */
  public static net.cloudburo.hexagon.demo.domain.covid.Header.Builder newBuilder() {
    return new net.cloudburo.hexagon.demo.domain.covid.Header.Builder();
  }
   ...
   * @return A new Header RecordBuilder
   */
  public static net.cloudburo.hexagon.demo.domain.covid.Header.Builder newBuilder(net.cloudburo.hexagon.demo.domain.covid.Header.Builder other) {
    return new net.cloudburo.hexagon.demo.domain.covid.Header.Builder(other);
  }
   ...
   * @return A new Header RecordBuilder
   */
  public static net.cloudburo.hexagon.demo.domain.covid.Header.Builder newBuilder(net.cloudburo.hexagon.demo.domain.covid.Header other) {
    return new net.cloudburo.hexagon.demo.domain.covid.Header.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Header>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.cloudburo.hexagon.demo.domain.covid.Header.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.cloudburo.hexagon.demo.domain.covid.Header other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.avroFingerprint)) {
        this.avroFingerprint = data().deepCopy(fields()[0].schema(), other.avroFingerprint);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.cloudburo.hexagon.demo.domain.covid.Header.Builder setAvroFingerprint(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.cloudburo.hexagon.demo.domain.covid.Header.Builder clearAvroFingerprint() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.cloudburo.hexagon.demo.domain.covid.Header.Builder setLastUpdateLoginId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.cloudburo.hexagon.demo.domain.covid.Header.Builder clearLastUpdateLoginId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.cloudburo.hexagon.demo.domain.covid.Header.Builder setLastUpdateTimestamp(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.cloudburo.hexagon.demo.domain.covid.Header.Builder clearLastUpdateTimestamp() {
